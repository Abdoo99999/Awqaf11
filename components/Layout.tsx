...
const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // --- دالة الحماية (The Guard) ---
  const handleItemClick = (e: React.MouseEvent, path: string) => {
    // إذا حاول المستخدم (غير المدير) دخول التقييم، نفحص "مفتاح العبور"
    ...
    // في الموبايل، نغلق القائمة عند الضغط على أي رابط
        ...
        <div className="flex items-center justify-between p-4 border-b border-navy-800 min-h-[5rem]">
          <div className="flex items-center gap-3">
             ...
             <div className="flex flex-col">
                 <h1 className="text-sm font-bold text-white leading-tight">نظام تقييم المؤسسات</h1>
